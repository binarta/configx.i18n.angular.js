# configx.i18n.angular.js

[AngularJS](http://angularjs.org/) module for publicly readable configuration values backed by the i18n feature of the [Binarta](http://binarta.com/) platform.
